  ...
  useEffect(() => {
    const subscription = alanEventEmitter.addListener("command", (data) => {
      ...
      if (data.command == "menu") {
        AlanManager.playText(
          "Let me show you a list of food categories which i have "
        );
        setTimeout(() => {
          setFoodScreen(true);
          setHomeScreen(false);
          ...
          >
            ...
            >
              <View style={{ flexDirection: "row" }}>
                <Text style={{ ...FONTS.body3 }}>{item.categories}</Text>
      ...
      return (
        <View style={{ alignItems: "center", justifyContent: "center",marginTop:40 }}>
          ...
          >
            ...
            >
              <Text style={{ ...FONTS.h3 }}>{restaurant.merchant}</Text>
            </View>
          </View>
        </View>
      );
      ...
      return (
        <View style={{ alignItems: "center", marginTop:40 }}>
          ...
          >
            ...
            >
              {restaurant.name} - {restaurant.price.toFixed(2)}
            </Text>
          ...
          >
            ...
            >
              {restaurant.calories.toFixed(2)} cal
            </Text>
          </View>
        </View>
      );
